    ...
    def getTrainingDataset() -> np.ndarray:
        ...
        return np.array([["Hi, what's your phone number?", InquiryDataset.contact],
                         ...
                         ["Thanks a lot. Got a package and everything is great, the quality's above the sky!",
                             InquiryDataset.feedback],
                         ["Everythign is awesome! The book itself is interesting and breathtaking. The delivery didn't take long. 5 stars", InquiryDataset.feedback],
                         ...
                         ["My son's going to school. Do you have any shoes size 9.",
                             InquiryDataset.recommendation],
                          ["My daughter is going to the university. I need nice comfortable shoes.", InquiryDataset.recommendation],
                         ["Hi, how many cores does IPhone's processor have?", InquiryDataset.dataset_search],
                         ["Hey, i need a phone for my parent asap. It has to be cheap and fast.", InquiryDataset.recommendation],
